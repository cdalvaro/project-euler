...
namespace challenges {
    ...
    private:
        ...
        /**
         ...
         @param first Constant iterator pointing to the first number of the range
         @param last Constant iterator pointing to the last number of the range (This number is not taken into account)
         
         @return The accumulation for the given range
         */
        static Type_t accumulate(std::string_view::const_iterator first,
